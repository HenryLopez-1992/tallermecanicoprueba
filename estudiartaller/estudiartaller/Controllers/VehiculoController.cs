...
namespace estudiartaller.Controllers
{
    public class VehiculoController : Controller
    {
        ...
        public VehiculoController(estudiartallerContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NumeroPlaca,Descripcion,NumeroMotor,NumeroChasis")] Vehiculo vehiculo)
        {
            if (id != vehiculo.Id)
            {
                return NotFound();
